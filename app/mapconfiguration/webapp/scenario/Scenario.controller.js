sap.ui.define([
	"com/sap/nss/nsaa/mapconfiguration/BaseController",
	...
	return BaseController.extend("com.sap.nss.nsaa.mapconfiguration.scenario.Scenario", {
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		onInit: function () {
			...
			this._oActionColModel = new JSONModel(sap.ui.require.toUrl("com/sap/nss/nsaa/mapconfigutation/jsonmodels/Actions.json"));

			//Actions Value Help Dialog
			this._oLayer = this.getView().byId("idLayer");
			this._oLayer.addValidator(this._onLayerValidate);
			this._oLayerColModel = new JSONModel(sap.ui.require.toUrl("com/sap/nss/nsaa/mapconfigutation/jsonmodels/Layers.json"));
			...
			this._oBusinessObjectColModel = new JSONModel(sap.ui.require.toUrl("com/sap/nss/nsaa/mapconfigutation/jsonmodels/BusinessObjects.json"));
		},
		 ...
		 */
		 onAdd: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("/Scenarios", {
		 ...
		 */
		 _fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Scenarios", oData);
		...
		onActionValueHelpRequested: function() {
			...
			this._oActionValueHelpDialog = sap.ui.xmlfragment("com.sap.nss.nsaa.mapconfiguration.fragments.Actions", this);
		...
		onLayerValueHelpRequested: function() {
			...
			this._oLayerValueHelpDialog = sap.ui.xmlfragment("com.sap.nss.nsaa.mapconfiguration.fragments.Layers", this);
		...
		onBusinessObjectValueHelpRequested: function() {
			...
			this._oBusinessObjectValueHelpDialog = sap.ui.xmlfragment("com.sap.nss.nsaa.mapconfiguration.fragments.BusinessObjects", this);
			...
			this._oBusinessObjectValueHelpDialog.getTableAsync().then(function (oTable) {
				...
				if (oTable.bindRows) {
					oTable.bindAggregation("rows", "/BusinessObjectType");
				}

				if (oTable.bindItems) {
					oTable.bindAggregation("items", "/BusinessObjectType", function () {
						return new ColumnListItem({
							cells: aCols.map(function (column) {
								return new Label({
									text: "{" + column.template + "}"
