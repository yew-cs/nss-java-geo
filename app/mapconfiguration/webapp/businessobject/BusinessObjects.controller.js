sap.ui.define([
	...
	var PageController = Controller.extend("com.sap.nss.nsaa.mapconfiguration.businessobject.BusinessObjects", {
		...
		_getFormFragment: function (sFragmentName) {
			...
			if (!pFormFragment) {
				pFormFragment = Fragment.load({
					id: oView.getId(),
					name: "com.sap.nss.nsaa.mapconfiguration.businessobject." + sFragmentName
				});
