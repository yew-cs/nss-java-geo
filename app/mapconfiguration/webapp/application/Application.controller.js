sap.ui.define([
	...
	var PageController = Controller.extend("com.sap.nss.nsaa.mapconfiguration.application.Application", {

		onInit: function () {
			var oModel = new JSONModel(sap.ui.require.toUrl("com/sap/nss/nsaa/app/mockdata/applications.json"));
