sap.ui.define([
	...
	return BaseObject.extend("com.bp.CRUDMasterDetail2.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.bp.CRUDMasterDetail2.model.ListSelector
		 */
		 ...
		 * @return {com.bp.CRUDMasterDetail2.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
		 ...
		 * @public
		 */
		findNextItem: function (sCurrentPath, _oList) {
			var aItems = _oList.getItems();
		 ...
		 * @public
		 */
		findListItem: function (sPath, _oList) {
			var aItems = _oList.getItems();
