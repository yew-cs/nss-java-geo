sap.ui.define([
	...
	var PageController = Controller.extend("com.sap.nss.nsaa.mapconfiguration.action.Action", {
		...
		_getFormFragment: function (sFragmentName) {
			...
			if (!pFormFragment) {
				pFormFragment = Fragment.load({
					id: oView.getId(),
					name: "com.sap.nss.nsaa.mapconfiguration.action." + sFragmentName
				});
		...
		handleEditPress: function () {
			//Clone the data
			this._oAction = Object.assign({}, this.getView().getModel().getData().ActionCollection[0]);
		...
		handleCancelPress: function () {
			...
			oData.ActionCollection[0] = this._oAction;
