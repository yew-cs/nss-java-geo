sap.ui.define([
	...
	return BaseController.extend("com.sap.nss.nsaa.businessobject.BusinessObjects", {
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		 ...
		 */
		 onAdd: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("/BusinessObjectTypes", {
		 ...
		 */
		 _fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("BusinessObjects", oData);
