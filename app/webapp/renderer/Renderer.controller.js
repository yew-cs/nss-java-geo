sap.ui.define([
	...
	return BaseController.extend("com.sap.nss.nsaa.renderer.Renderer", {
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		 ...
		 */
		 onAdd: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("/Renderers", {
		 ...
		 */
		 _fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Renderers", oData);
