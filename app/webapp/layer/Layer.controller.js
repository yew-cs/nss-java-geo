sap.ui.define([
	...
	return BaseController.extend("com.sap.nss.nsaa.layer.Layer", {
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		 ...
		 */
		 onAdd: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("/Layers", {
		 ...
		 */
		 _fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Layers", oData);
